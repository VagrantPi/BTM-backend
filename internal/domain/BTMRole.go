...
const DefaultRoleRaw = `[{"id":"viewBar","path":"/view","name":"圖表","meta":{"roles":["admin"],"title":"圖表","icon":"component"},"children":[{"id":"viewDashboard","path":"dashboard","name":"Dashboard","meta":{"title":"Dashboard","icon":"dashboard","roles":["admin"]}}]},{"id":"permissionBar","path":"/permission","name":"後台管理","meta":{"roles":["admin"],"title":"後台管理","icon":"lock"},"children":[{"id":"adminUsers","path":"user","name":"後台用戶管理","meta":{"title":"後台用戶管理","icon":"el-icon-s-custom","roles":["admin"]}},{"id":"permission","path":"index","name":"權限管理","meta":{"title":"權限管理","icon":"el-icon-s-check","roles":["admin"]}}]},{"id":"userBar","path":"/user","redirect":"/user/page","name":"會員總覽","meta":{"title":"會員總覽","icon":"user","roles":["admin"]},"children":[{"id":"users","path":"users","name":"會員總覽","meta":{"title":"會員總覽","icon":"user","roles":["admin"],"noCache":true}},{"id":"userInfo","path":"info","name":"會員總覽 > 基本資料","meta":{"title":"基本資料","icon":"user","roles":["admin"],"noCache":true}},{"id":"riskView","path":"view","name":"會員總覽 > 風控限額編輯","meta":{"title":"風控限額編輯","roles":["admin"]}},{"id":"transaction","path":"/transaction","name":"交易記錄","meta":{"title":"交易記錄","icon":"el-icon-s-order","roles":["admin"],"noCache":true}}]},{"id":"reviewBar","path":"/review","redirect":"/review/cibs","name":"審核作業","meta":{"title":"審核作業","icon":"list","roles":["admin"]},"children":[{"id":"cibs","path":"cibs","name":"告誡名單","meta":{"title":"告誡名單","icon":"el-icon-s-flag","roles":["admin"],"noCache":true}},{"id":"cibsUpload","path":"cibs/upload","name":"上傳告誡名單","meta":{"title":"上傳告誡名單","icon":"el-icon-upload","roles":["admin"],"noCache":true}},{"id":"addresslist","path":"addresslist","name":"綁定地址","meta":{"title":"綁定地址","icon":"education","roles":["admin"],"noCache":true}},{"id":"addresslistView","path":"/addresslist/view","name":"綁定地址編輯","meta":{"title":"綁定地址編輯","roles":["admin"],"noCache":true}}]},{"id":"riskBar","path":"/risk_control","redirect":"/risk_control/page","name":"風險管理","meta":{"title":"風險管理","icon":"component","roles":["admin"]},"children":[{"id":"riskMemberList","path":"risk_member_list","name":"會員風控管理","meta":{"title":"會員風控管理","icon":"el-icon-warning","roles":["admin"]}},{"id":"riskControlHistory","path":"history","name":"會員風控管理 > 修改紀錄","meta":{"title":"風控修改紀錄","roles":["admin"]}},{"id":"eddList","path":"edd_list","name":"EDD名單","meta":{"title":"EDD名單","icon":"el-icon-warning-outline","roles":["admin"]}}]},{"id":"settingBar","path":"/setting","redirect":"/setting/page","name":"系統參數設定","meta":{"title":"系統參數設定","icon":"el-icon-document","roles":["admin"]},"children":[{"id":"systemSetting","path":"page","name":"設定內容","meta":{"title":"設定內容","icon":"el-icon-edit-outline","roles":["admin"]}},{"id":"systemSettingHistory","path":"history","name":"設定紀錄","meta":{"title":"設定紀錄","icon":"el-icon-document-copy","roles":["admin"]}}]},{"id":"systemBar","path":"/system","redirect":"/system/lamassu_logs","name":"系統維護","meta":{"title":"系統維護","icon":"el-icon-coffee-cup","roles":["admin"]},"children":[{"id":"lamassuLogs","path":"lamassu_logs","name":"Lamassu日誌","meta":{"title":"Lamassu日誌","icon":"el-icon-timer","roles":["admin"],"noCache":true}},{"id":"serverLogs","path":"server_logs","name":"伺服器日誌","meta":{"title":"伺服器日誌","icon":"el-icon-timer","roles":["admin"],"noCache":true}},{"id":"mockLimitLogs","path":"mock_limit_logs","name":"限額塞入假交易紀錄","meta":{"title":"限額塞入假交易紀錄","icon":"el-icon-discover","roles":["admin"],"noCache":true}},{"id":"tools","path":"tools","name":"RD工具","meta":{"title":"RD工具","icon":"el-icon-goblet-square-full","roles":["admin"],"noCache":true}},{"id":"smsTools","path":"sms_tools","name":"SMS工具","meta":{"title":"SMS工具","icon":"el-icon-chat-line-square","roles":["admin"],"noCache":true}}]}]`
